...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="{{asset('passets/images/logo.svg')}}" width="48" height="48" alt="Compass"></div>
        <p>Please wait...</p>
    </div>
</div>
...
<nav class="navbar">
    <div class="col-12">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/"><img src="{{asset('passets/images/logo.svg')}}" width="30" alt="Compass"><span class="m-l-10">KShop</span></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li>
                <form method="Post" action="{{route('logout')}}">
                    @csrf
                    <button class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></button>
                </form>
            </li>
...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            {{--<li>--}}
            {{--<div class="user-info">--}}
            {{--<div class="image"><a href="profile.html"><img src="{{asset('passets/images/profile_av.jpg')}}" alt="User"></a></div>--}}
            {{--<div class="detail">--}}
            {{--<h4>Michael</h4>--}}
            {{--<small>Agent</small>--}}
            {{--</div>--}}
    ...
    <div class="tab-content">
        <div class="tab-pane active slideRight" id="setting">
            <div class="slim_scroll">
                ...
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar4.jpg')}}" alt="">--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar5.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar2.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar1.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar3.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar10.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                {{--<span class="badge badge-outline status"></span>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar6.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                {{--<span class="badge badge-outline status"></span>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar7.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                {{--<span class="badge badge-outline status"></span>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar8.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                {{--<span class="badge badge-outline status"></span>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<a href="javascript:void(0);">--}}
                {{--<div class="media">--}}
                {{--<img class="media-object " src="{{asset('passets/images/xs/avatar9.jpg')}}" alt="">--}}
                {{--<div class="media-body">--}}
                {{--<span class="badge badge-outline status"></span>--}}
                {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar2.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar3.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar4.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--</ul>--}}
                {{--</div>--}}
                {{--<div class="progress-container">--}}
                ...
                {{--<li class="m-r-15"><small>Team</small></li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar10.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar9.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar8.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar7.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar6.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--</ul>--}}
                {{--</div>--}}
                {{--<div class="progress-container progress-warning">--}}
                ...
                {{--<li class="m-r-15"><small>Team</small></li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar5.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
                {{--<li>--}}
                {{--<img src="{{asset('passets/images/xs/avatar2.jpg')}}" alt="Avatar">--}}
                {{--</li>--}}
            ...
            <div class="chat-widget">
                <ul class="chat-scroll-list clearfix">
                    <li class="left float-left">
                        <img src="{{asset('passets/images/xs/avatar3.jpg')}}" class="rounded-circle" alt="">
                        <div class="chat-info">
                    ...
                    <li class="left float-left"> <img src="{{asset('passets/images/xs/avatar2.jpg')}}" class="rounded-circle" alt="">
                    ...
                    <li class="left float-left"> <img src="{{asset('passets/images/xs/avatar1.jpg')}}" class="rounded-circle" alt="">
...
<!-- Jquery Core Js -->
<script src="{{asset('passets/bundles/libscripts.bundle.js')}}"></script> <!-- Lib Scripts Plugin Js ( jquery.v3.2.1, Bootstrap4 js) -->
<script src="{{asset('passets/bundles/vendorscripts.bundle.js')}}"></script> <!-- slimscroll, waves Scripts Plugin Js -->

<script src="{{asset('passets/bundles/mainscripts.bundle.js')}}"></script>
</body>
</html>
