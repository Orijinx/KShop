            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> KSHOP</a></li>
                        <li class="breadcrumb-item active">Панель статистики</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="body">
                            <h3 class="number count-to" data-from="0" data-to="128" data-speed="2000"
                                data-fresh-interval="700">{{count($us)}}</h3>
                    ...
                    <div class="card">
                        <div class="body">
                            <h3 class="number count-to" data-from="0" data-to="758" data-speed="2000"
                                data-fresh-interval="700">{{count($prod)}}</h3>
                            <p class="text-muted">Типов Продукции</p>
                            {{--<div class="progress">--}}
                    ...
                    <div class="card">
                        <div class="body">
                            <h3 class="number count-to" data-from="0" data-to="2521" data-speed="2000"
                                data-fresh-interval="700">{{count($orders)}}</h3>
                            <p class="text-muted">Все заказы</p>
                            {{--<div class="progress">--}}
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="body">
                            <h3>{{$total}} руб.</h3>
                            <p class="text-muted">Полученная сумма за все время</p>
                            {{--<div class="progress">--}}
            ...
            <div class="row clearfix" >
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="body">
                            <canvas width="100px" height="100px" id="popChart"></canvas>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card">
                        <div class="body">
                            <canvas width="100px" height="100px" id="indexChart"></canvas>
            ...
            <script>
                ...
                x.onload = function () {
                    if (x.status != 200) { // анализируем HTTP-статус ответа, если статус не 200, то произошла ошибка
                        alert(`Ошибка ${xhr.status}: ${xhr.statusText}`); // Например, 404: Not Found
                    } else { // если всё прошло гладко, выводим результат
                        var name = [];
                        var count = [];
                        x.response.forEach(function(item) {
                            console.log(item)
                            name.push(item.name)
            ...
            <script>
                var pCanvas = document.getElementById("indexChart");
                ...
                xhr.onload = function () {
                    if (xhr.status != 200) { // анализируем HTTP-статус ответа, если статус не 200, то произошла ошибка
                        ...
                        xhr.response.forEach(function(item) {
                            ...
                            n.push(date.getDate() +"."+date.getMonth() +"."+date.getFullYear())
                            c.push(item.count)
                        });


                        var baChart = new Chart(pCanvas, {
                            type: 'bar',
                            data: {
                                labels: n ,
                                datasets: [{
                                    label: 'Посещаемость главной страницы',
                                    data: c,
                                    backgroundColor: [
                                        'rgba(255, 99, 132, 0.6)'
                                    ]
                ...
                xhr.onerror = function () {
                    alert("Получить время не удалось");
                };
